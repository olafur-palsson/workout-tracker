...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__test_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(10);




Object(__WEBPACK_IMPORTED_MODULE_0__test_js__["a" /* default */])();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DataController__ = __webpack_require__(4);
...
const test = async () => {
  let dataController = __WEBPACK_IMPORTED_MODULE_0__DataController__["a" /* default */].setCredentials();
  let response = await dataController.user.newUser("oli", "oli", "oli");
  console.log(response);
  dataController = __WEBPACK_IMPORTED_MODULE_0__DataController__["a" /* default */].setCredentials("oli", "oli");
...
let Request = new __WEBPACK_IMPORTED_MODULE_0__Request__["a" /* default */]();
...
/* harmony default export */ __webpack_exports__["a"] = ({ setCredentials });
...
class RequestBuilder {
	...
	make(requestString) {
		...
		if (this.username && this.password) req.setRequestHeader("Authorization", auth);
		req.send();
...
/* harmony default export */ __webpack_exports__["a"] = (RequestBuilder);
