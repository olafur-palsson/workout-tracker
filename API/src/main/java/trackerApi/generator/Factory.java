 ...
 * Heiti verkefnis: trackerApi.generator
 */
...
package trackerApi.generator;
     ...
     import static trackerApi.generator.Entity.pair;
...
public abstract class Factory<Ent extends Entity> {
    ...
    // Nytt factory verdur ad vera med thessa fields assigned i constructor
	...
	// thetta fall tharf ad bua til object af gerd Ent ut fra JSON file
    protected abstract Ent jsonToEntity(JSONObject json);

    // thetta tharf ad skila Ent, sama hvernig thad er, gott ef thad er random
    // ef madur vill mockdata
	...
	public boolean remove(Long id) throws IOException {
		Pair<String, String> pair = pair("id", "" + id);
		Request r = new Request(removeURL, pair);
		r.resolve();
		return true;
	}

	//returns id of object in database
	...
	// Eg veit ekki af hverju thetta virkar
	public ArrayList<Long> getAsArrayListOfLong(String key, JSONObject o) {
	    ArrayList<Long> list = new ArrayList<>();
	    List fromJSON = getArrayListFromJSON(key, o);
	    for(Object number : fromJSON) {
	        Long l;
	        try {
	            l = Long.parseLong(number.toString());
            } catch (ClassCastException e) {
	            try {
	                l = new Long((Integer) number);
	...
	protected static List getArrayListFromJSON(String keyName, JSONObject o) {
	    ArrayList list = new ArrayList<>();
	    int i = 0;
        JSONArray array = (JSONArray) o.get(keyName);
        while(true)
            try {
	...
	public static double  randomDouble(double begin, double width) { return begin + Math.random() * width; }
	...
	//for long text like historys we put them into arraylist :)
	...
	public static Map<Long, Integer> getRandomSetList() {
	...
	*******************************************/
	...
	public static final String[] exerciseName = {
		"Wet_Spring_Exercise",
		"Bree_Wonder",
		"Exercise_Exercise",
		"Exercise_Fighters",
		"Exercise_Red_Day",
		"You're_Going_To_Want_To_Eat_this_Exercise",
		"Between_the_Exercises_and_Me",
		"Megaexercise",
		"Exercise_Dream_and_a_Pinch_of_Salt",
		"My_Wet_Romance",
		"Brians_Wet_Exercise",
		"No_Exercise,_Only_Steak",
		"Of_Men_and_Humming_Birds",
		"Saving_Bree",
		"School_of_the_One_Zillion_Humming_Birds",
		"They_Might_Be_Wet_Humming_Birds",
		"One_Zillion_Humming_Birds",
		"Exercise_Exercise_Cult",
		"The_Reykjavik_Strippers",
		"Exercise_Kid_Bree",
		"Reykjavik_Thunder_Shoulders",
		"Exercise_One_Zillion",
		...
		"This_Exercise",
		"Its_My_Exercise",
		"Flight_of_the_Exercises",
		"Snuggling_in_Reykjavik",
		"Exerciseplay",
		"The_Exercise_Can_For_the_Street_Artists",
		"The_Wet_Street_Artistss_Club",
		"Exercise_Exercise",
		"Exercise_Fighters",
		"Exercise_Red_Day",
		"Exercises_and_a_Exercise",
		"Bree_Eats_the_Exercise",
		"Exercise_Dream_and_a_Pinch_of_Exercise",
		"My_Wet_Romance",
		"Brees_Wet_Exercise",
		"No_Exercise",
		"Reykjavik_Panic",
		"Exercises_for_the_Street_Artists",
		"Saving_Bree",
		"One_Zillion_Humming_Birds",
		"The_Snuggling_Exercise_Street_Artists",
		"Exercise_Attack",
		"Exercise_for_the_Street_Artists",
		"Exerciseback",
		"The_Exercise_Bree_Project",
		"Snuggling_Exercises",
		"Puddle_of_Exercise",
		"Disciples_Of_Reykjavik",
		"The_Exercise_B_Experience",
		"Snuggling_at_the_Disco",
		"Exercise_Army",
		"Exercise_Tribute",
		"This_Exercise",
